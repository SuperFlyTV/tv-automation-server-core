...
export const PlayoutDeviceSettingsComponent = translate()(class PlayoutDeviceSettingsComponent extends React.Component<Translated<IPlayoutDeviceSettingsComponentProps>, IPlayoutDeviceSettingsComponentState> {
								...
								<td colSpan={5}>
									<div>
										...
										</div>
										{
											...
											subDevice.type === PlayoutDeviceType.VMIX ?
												this.renderVMixDeviceSettings(subDevice, deviceId) :
											null
										}
									</div>
	...
	renderVMixDeviceSettings (_subDevice: PlayoutDeviceSettingsDevice, deviceId: string) {
		const { t } = this.props
		return <React.Fragment>
			<div className='mod mvs mhs'>
				<label className='field'>
